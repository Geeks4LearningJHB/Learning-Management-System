...
export class ApplicantionProgressComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.getCvDocumentsByUserId(this.userId)
    this.getIdDocumentsByUserId(this.userId)
    this.getQualificationDocumentsByUserId(this.userId)
    this.getVaccinationDocumentsByUserId(this.userId)
    
    
  }

  getQualificationDocumentsByUserId(userId: any) {
    this.applicantService.getQualificationDocumentsByUserId(userId)
      .subscribe(
        (response: any) => {
  ...
  getIdDocumentsByUserId(userId: any) {
    this.applicantService.getIdDocumentsByUserId(userId)
      .subscribe(
        (response: any) => {
          console.log('Response:', response);
        },
  ...
  getCvDocumentsByUserId(userId: any) {
    this.applicantService.getCvDocumentsByUserId(userId)
      .subscribe(
        (response: any) => {
          console.log('Response:', response);
        },
  ...
  getVaccinationDocumentsByUserId(userId: any) {
    this.applicantService.getVaccinationDocumentsByUserId(userId)
      .subscribe(
        (response: any) => {
          console.log('Response:', response);
        },
